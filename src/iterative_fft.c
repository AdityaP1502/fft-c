...
static void FFTLIBRARY_CALL normalize_ifft(bins xk, int length)
{
    for (int i = 0; i < length; i++)
    {
...
static bins FFTLIBRARY_CALL combined_two_real_input(double *xn_1, double *xn_2, int max_length, int min_length)
{
...
static void FFTLIBRARY_CALL seperate_combined_output(bins combined_output, int length, fft_bins **dest)
{
    fft_bins *result_1;
    fft_bins *result_2;
