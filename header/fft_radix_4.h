...
/*  Calculate IFFT of Xk using radix 4 fft. Xk is ordered and the result is ordered
    The order of calculation will be using the NR mode.  
*/
FFTLIBRARY_API fft_bins* FFTLIBRARY_CALL ifft_radix_4_iterative_static_n(bins xk, bins backward_twid_factor, int fft_size, int length);
...
*/
FFTLIBRARY_API ifft_symmetric_bins* FFTLIBRARY_CALL ifft_radix_4_iterative_symmetric_static_n(bins Xk, bins backward_twid_factor, int fft_size, int length);
